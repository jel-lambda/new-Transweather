...
import numpy as np
import random
from transweather_model import Transweather_base
...
val_filename = '1977.txt' ## This text file should contain all the names of the images and must be placed in ./data/test/ directory
